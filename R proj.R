...
####
# DATASETS
dataset1=read.csv("/Users/anirudhgambhir/Documents/COLLEGE/SEM5/R Prog./Datasets/College datasets/states.csv")
dataset2=read.csv("/Users/anirudhgambhir/Documents/COLLEGE/SEM5/R Prog./Datasets/College datasets/state_wise.csv")
dataset3<-read.csv("/Users/anirudhgambhir/Documents/COLLEGE/SEM5/R Prog./Datasets/College datasets/COVID.csv")
dataset4<-read.csv("/Users/anirudhgambhir/Documents/COLLEGE/SEM5/R Prog./Datasets/College datasets/StatewiseCovid.csv")
dataset5<-read.csv("/Users/anirudhgambhir/Documents/COLLEGE/SEM5/R Prog./Datasets/College datasets/COVID19_new_data.csv")
...
# ADDITIONAL
sum(dataset3$Cases)
table(dataset5$outcome) # 1 = DISCHARGED , 2= DEATH
